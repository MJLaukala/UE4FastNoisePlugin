...
#include "Models/FastNoiseEditorViewportClient.h"
...
public:
	...
	SLATE_BEGIN_ARGS(SFastNoiseEditorViewport) { }
	SLATE_END_ARGS()
...
public:
	 ...
	 */
	void Construct( const FArguments& InArgs, const TSharedRef<IFastNoiseEditor>& InToolkit );
...
private:
	...
	TWeakPtr<IFastNoiseEditor> ToolkitPtr;
	
	// Level viewport client.
	TSharedPtr<class FFastNoiseEditorViewportClient> ViewportClient;
