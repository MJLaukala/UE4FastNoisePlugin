...
class SFastNoiseEditorViewport;
class UTexture2D;

class FFastNoiseEditorViewportClient
	: public FViewportClient
	, public FGCObject
{
public:
	/** Constructor */
	FFastNoiseEditorViewportClient(TWeakPtr<IFastNoiseEditor> InFastNoiseEditor, TWeakPtr<SFastNoiseEditorViewport> InFastNoiseEditorViewport);
	~FFastNoiseEditorViewportClient();
...
private:
	...
	TWeakPtr<IFastNoiseEditor> FastNoiseEditorPtr;

	/** Pointer back to the Texture viewport control that owns us */
	TWeakPtr<SFastNoiseEditorViewport> FastNoiseEditorViewportPtr;
